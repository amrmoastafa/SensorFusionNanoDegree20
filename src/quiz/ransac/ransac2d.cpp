...
std::unordered_set<int> Ransac_Plane(pcl::PointCloud<pcl::PointXYZ>::Ptr cloud, int maxIterations, float distanceThreshold)
{
...
int main ()
{
	...
	std::unordered_set<int> inliers = Ransac_Plane(cloud, 10, 1.0);
